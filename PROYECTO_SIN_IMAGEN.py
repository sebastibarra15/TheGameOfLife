...
class GameofLife(Frame):
    def __init__(self):
        ...
        self.ins = Label(self.frame1,fg="snow",bg="gray8",width=80, height=10,
                         ...
                         text="""BIENVENIDOS AL JUEGO DE LA VIDA:\n
         Juego interactivo que consta de un sistema automata en el cual tras unas reglas muy simples, 
  ocultan un comportamiento de gran complejidad. Se plantea un mundo dentro de una cuadrilla bidimensional,
    donde se aprecian estados de vida o muerte, dejando que evolucione este conjunto de celulas formando 
     distintos patrones y simulando la vida misma al notar que un ser vivo es solo una casilla pequeña 
   cuyo destino es rapido e incierto. En memoria de John H.Conway, quien a traves de su trabajo ha inspirado 
  a mentes a desarrollarse en las matematicas y la computacion. Fallecido el 11 de Abril a causa de COVID-19.
                             """)
        ...
        self.btnstart=Button(self.frame3,text="START GAME", font=("Comic Sans MS","13","bold"),fg="snow",bg="forest green", command=self.GridGUI)
        self.btnstart.pack(side=LEFT,ipady=15,ipadx=15,padx=30,anchor="w")
        self.btninstr=Button(self.frame3,text="INSTRUCTIONS", font=("Comic Sans MS","13","bold"),fg="snow",bg="DodgerBlue4", command=self.Instructions)
    ...
    def Instructions(self):
        ...
        l1 = Label(root, text = "INSTRUCTIONS",font=("System","20","bold"), bg = 'gray8',fg="snow", relief = SUNKEN,height=3,width=15)
        l1.pack(fill = X)
        
        l2 = Label(root, text = """El juego a probar puede ser tanto interactivo como solo visual. Para probar tu mismo el juego,
        empieza presionando las casillas negras que representan las células muertas para darles vida,despues al 
        presionar START notaras el efecto y evolución de estos patrones dentro del juego, el cual puedes detener 
        y reiniciar con PAUSE y RESET respectivamente. Si deseas ver ejemplos de patrones y comportamientos o 
        figuras interesantes, puedes seleccionar la opción en barra de PREDETERMINED y luego START. 
        En caso quieras apreciar el movimiento en mayor o menor velocidad, puedes variarlo con los Radiobuttons, 
        en el mismo juego puedes acceder a este panel de instrucciones presionando HELP.""", font=("MS Sans Serif","14"),bg = 'DodgerBlue4',fg="snow", relief = GROOVE,height=8,width=10 )
        l2.pack(fill = X,padx=2)
        
        f34=Frame(root)
        f34.pack(fill=BOTH,expand=1)
        l3 = Label(f34, text = "1. NACER: Si un espacio contiene 3 vecinos vivos,\n nace una celula",font=("MS Sans Serif","14"), bg = 'forest green',fg="snow", relief = GROOVE,width=5)
        l3.pack(side = LEFT,fill = BOTH, expand = 1)
        
        l4 = Label(f34, text = "2. SOBREVIVIR: La celula persiste en el siguiente\n instante si tiene 2 o 3 vecinos vivos",font=("MS Sans Serif","14"),fg="snow", bg = 'forest green', relief = GROOVE,width=5)
        l4.pack(side = RIGHT, fill=BOTH, expand = 1)
        
        f56=Frame(root)
        f56.pack(fill=BOTH,expand=1)
        l5 = Label(f56, text = "3. MORIR: Mas de 3 vecinos vivos ocasionan la \nmuerte en el siguiente instante por sobrepoblacion",font=("MS Sans Serif","14"),fg="snow", bg = 'forest green', relief = GROOVE,width=5)
        l5.pack(side = LEFT,fill=BOTH, expand = 1)
        
        l6 = Label(f56, text = "4. MORIR: Menos de 2 vecinos vivos ocasiona la \nmuerte en el siguiente instante por soledad",font=("MS Sans Serif","14"),fg="snow", bg = 'forest green', relief = GROOVE,width=5)
    ...
    def GridGUI(self):
        ...
        self.scorelabel=Label(score,text=" "+ str(self.code),font=("System","17"),bg="forest green",relief=GROOVE)
    ...
    def GameAlgorithm(self):
        ...
        for i in range(20):
            for j in range(40):
                ...
                elif self.cells[i][j]['bg'] == self.coloralive and self.neighbourbehavior(i,j) != 3 and self.neighbourbehavior(i,j) != 2:
                    self.behavior.append(bwcoord)
    ...
    def Predetermined(self,event):
        ...
        comms2 = [(8,18),(8,19),(8,21),(8,22),(9,18),(9,19),(9,21),(9,22),(10,19),(10,21),(11,17),
                  (11,19),(11,21),(11,23),(12,17),(12,19),(12,21),(12,23),(13,17),(13,18),(13,22),(13,23)]
        
        comms3 = [(3,24),(3,25),(3,35),(3,36),(4,23),(4,25),(4,35),(4,36),(5,1),(5,2),(5,10),(5,11),
                  (5,23),(5,24),(6,1),(6,2),(6,9),(6,11),(7,9),(7,10),(7,17),(7,18),(8,17),(8,19),
                  (9,17),(10,36),(10,37),(11,36),(11,38),(12,36),(15,25),(15,26),(15,27),(16,25),(17,26)]
        ...
        comms8 = [(7,13),(7,15),(7,17),(8,13),(8,17),(9,13),(9,17),(10,13),(10,17),(11,13),(11,15),(11,17)]
        
        comms9 = [(11,24),(11,25),(12,23),(12,24),(13,24)]

        comms10 = [(12,5),(12,6),(12,7),(13,4),(13,7),(14,7),(15,7),(16,17),(17,7),(18,6),(16,10),(17,10),(17,11),(18,10),(18,11),
                   (12,14),(13,13),(13,14),(13,15),(14,12),(14,13),(14,15),(12,20),(13,19),(13,20),(13,21),(14,19),(14,21),(14,22),
                   (16,24),(17,23),(17,24),(18,23),(18,24),(12,27),(13,27),(14,27),(15,27),(16,27),(17,27),(18,28),(12,28),(12,29),(13,30)]
